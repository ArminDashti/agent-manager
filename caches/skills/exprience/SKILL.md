...
name: exprience
description: >-
  Records problems, issues, and project learnings as question-and-answer entries in ./exprience/exprience.md at the project root.
  Use when the user asks to save, record, log, or capture an experience, problem, issue, solution, or lesson learned for the current project.
---
